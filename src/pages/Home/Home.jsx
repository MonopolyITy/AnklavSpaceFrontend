...
const Home = () => {
  return (
    <div style={{margin: "20px"}}>
      <div>
        <Link to="/quiz" className="font-display" style={{background: "#4E4C50", borderRadius: "5px", color: "white", height: "50px", fontSize: "13px", display: "flex", justifyContent: "center", alignItems: "center"}}>
